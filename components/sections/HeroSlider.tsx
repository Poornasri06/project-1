...
const slides = [
  {
    ...
    desc: <>SEED delivers MEP engineering, sustainability consulting, BIM coordination, and commissioning services for complex developments across the Middle East, Africa, and India.</>,
    image: '/projects/mandarin-wasl-tower.webp',
    projectInfo: 'Mandarin Oriental Wasl Tower — Dubai, UAE',
  },
  {
    eyebrow: 'MEP · SUSTAINABILITY · BIM · COMMISSIONING',
    title: <>Engineering<br/>High-Performance<br/>Buildings</>,
  ...
  {
    eyebrow: 'ENGINEERING PERFORMANCE VERIFICATION',
    title: 'SEED',
    desc: 'Engineering responsibility does not end with drawings. We verify performance in the field — through commissioning, testing and review.',
  ...
  },
  {
    ...
    projectInfo: 'St. Regis Branded Residence — Abu Dhabi, UAE',
  }
];
